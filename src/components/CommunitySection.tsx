      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            Engage with fellow BTCS enthusiasts across Discord, Telegram, and X.
            Participate in discussions, events, and the latest updates.
          </p>
        ...
        >
          <Card className="overflow-hidden">
            ...
            <CardContent className="p-0">
              <iframe
                src="https://discord.com/widget?id=1539491535651999815&theme=dark"
                width="100%"
                height="500"
